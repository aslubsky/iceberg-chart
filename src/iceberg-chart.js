(function (root, factory) {
    ...
    var IcebergChart = function (canvasElement, options) {
        ...
        this.draw = function () {
            ...
            var points = this.drawWhiteIceberg(xCenter, hOffset, vOffset, topHeight, icebergHeight, icebergWidth);
            //console.log(points);
            this.drawUnknownPart(xCenter, hOffset + topHeight + 1, points);
            ...
            if (this.data.unknown > 0) {
                this.drawLabel(xCenter, icebergHeight - Math.ceil(bottomHeight / 4),
                    this.canvas.width + hOffset / 2 - 10, icebergHeight - Math.ceil(bottomHeight / 4) - 10,
        ...
        this.drawWhiteIceberg = function (xCenter, hOffset, vOffset, topHeight, icebergHeight, icebergWidth) {
            var points = [];
            this.ctx.lineWidth = 1;
            this.ctx.miterLimit = 10;
            ...
            points = points.concat(this.drawBrokenLine(vOffset, hOffset + topHeight, xCenter, hOffset + icebergHeight, 1));
            points = points.concat(this.drawBrokenLine(xCenter, hOffset + icebergHeight, vOffset + icebergWidth, hOffset + topHeight, 1));
